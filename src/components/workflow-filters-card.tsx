...
interface WorkflowFiltersCardProps {
  filters: WorkflowFilters;
  onChange: Dispatch<SetStateAction<WorkflowFilters>>;
}

export function WorkflowFiltersCard({ filters, onChange }: WorkflowFiltersCardProps) {
  return (
